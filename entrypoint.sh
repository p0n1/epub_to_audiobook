...
if [ $# -eq 0 ] || { [ "$1" = "--host" ] || [ "$1" = "--port" ]; }; then
    ...
    # Otherwise, execute the default python3 /app/main.py command with all arguments
    echo "Executing default command: python3 /app/main.py $@"
