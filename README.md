...
- **TTS Provider Selection**: Easy switching between Azure, OpenAI, Edge, Piper, and Pocket-TTS with provider-specific options
...
2. **Choose your TTS provider** from the tabs (OpenAI, Azure, Edge, Piper, or Pocket-TTS)
